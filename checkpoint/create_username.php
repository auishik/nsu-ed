...
<body id="page_verify">
  ...
  <div class="container">
    <h1 class="page-header"><span class="glyphicon glyphicon-bell glyphicon-pad"></span> Choose Username</h1>
    <div class="row clearfix">
      <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
        <h2 class="text-center">Enter your username!</h2>
        <p class="errata text-muted">Te hinc laudem sea. Virtute fabellas mea no, et duis intellegam cum. Cu tota adhuc quo, dicit dolor nec an. Quando vocibus scribentur eam ex, <a class="text-info" href="#">code of conduct</a> principes ea. Ignota equidem id has, no quis molestiae eam, denique deseruisse nec id. Ne elaboraret adversarium mea.</p>
        <form>
          <div class="form-group">
