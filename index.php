  				...
  				<div class="tab-pane fade" id="sign_up">
  					<form>
  						<div class="form-group">
    						...
    						<input type="text" class="form-control" id="id" placeholder="identity number">
  						</div>
  						<div class="form-group">
    						<label for="id_confirm">Confirm ID</label>
    						<input type="text" class="form-control" id="id_confirm" placeholder="confirm identity number">
  						</div>
  						<button type="submit" class="btn btn-primary">Submit</button>
  					</form>
  				</div><!--#sign_up-->
