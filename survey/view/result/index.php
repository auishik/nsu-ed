...
<body id="page_survey">
  ...
  <div class="container">
    <h1 class="page-header"><span class="glyphicon glyphicon-sunglasses glyphicon-pad"></span> Survey Results</h1>
    ...
    <div class="row row-offcanvas row-offcanvas-right">
      <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10">
        ...
        <div class="col-lg-12"><!--content-->
          ...
          <h4><span class="glyphicon glyphicon-question-sign glyphicon-pad"></span> 1. Who won the tournament?</h4>
          <ul class="list-group">
            <li class="list-group-item">Some of them and many more <span class="badge">14</span></li>
            <li class="list-group-item">None of them and no more <span class="badge">14</span></li>
            <li class="list-group-item">Few of them and some more <span class="badge">14</span></li>
            <li class="list-group-item">All of the above <span class="badge">14</span></li>
          </ul>
