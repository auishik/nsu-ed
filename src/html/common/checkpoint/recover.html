...
<body id="page_verify">
  ...
  <div class="container">
    <h1 class="page-header"><span class="glyphicon glyphicon-bell glyphicon-pad"></span>Account Recovery</h1>
    <div class="row clearfix">
      <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
        <h2 class="text-center">Enter your <abbr title="identification number">ID</abbr>!</h2>
